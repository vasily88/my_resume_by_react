    ...
    <>
      <div className="main">
        <div className="centerPage">
          ...
          <Routes>
            <Route path="/my_resume/dist/" element={<HomePage positionImage={positionImage}/>} />
            <Route path="/my_resume/dist/my-works" element={<MyWorks />} />
            <Route path="/my_resume/dist/resume" element={<Resume />} />
          </Routes>
